...
import { currentApp } from '../../services/navigation-signals.js';
...
export class CommandsApp extends HTMLElement {
  ...
  connectedCallback() {
    ...
    // Subscribe to navigation signals (reactive open/close)
    this.#disposeEffect = effect(() => {
      const isVisible = currentApp.value?.id === 'commands';
      if (isVisible) {
        this.open();
      } else {
        this.close();
  ...
  disconnectedCallback() {
    ...
    // Clean up navigation effect subscription
    this.#disposeEffect?.();
  }
